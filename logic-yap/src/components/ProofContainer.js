...
function ProofContainer() {
  return (
    <div className="proof-container bg-primary-50 w-full h-[60vh] rounded-lg shadow-lg p-6 mx-auto mt-8">
      <h1 className="text-xl font-semibold mb-4">Proof Assistant</h1>
